...
from current_season_modules.data_loading import load_official_oaa_data, load_yearly_catcher_framing_data
...
def compare_oaa_calculations():
    ...
    from shared_modules.modularized_data_parser import create_name_mapping
