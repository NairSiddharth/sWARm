"""
Centralized logging configuration for oWAR project.

This module provides a configured logger that should be used throughout
the project for consistent logging behavior.
...
def get_logger(name: str, log_file: Optional[str] = None) -> logging.Logger:
	...
	if not logger.handlers:
		...
		if log_file is None:
			log_file = f"owar_{datetime.now():%Y%m%d}.log"
...
module_logger.info("Logging module initialized")