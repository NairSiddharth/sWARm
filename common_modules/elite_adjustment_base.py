"""
Elite Player Adjustment Base Module
====================================

Base class implementing confidence-based regression reduction to protect elite players
from over-regression before mathematical constraints are applied.

This module contains the core ElitePlayerAdjuster class that was previously
in the monolithic elite_adjustment.py file.
"""
