...
def prepare_data_for_kfold():
    ...
    from modules.basic_cleaners import clean_defensive_players
    from modules.name_mapping_optimization import create_optimized_name_mapping_with_indices
    ...
    from modules.positional_adjustments import load_positional_adjustments_for_war_models
    ...
    def prepare_dataset(warp_data, war_data, mapping, enhanced_br, enhanced_def, player_type, bp_pos, fg_pos):
        ...
        def add_enhanced_features(df, data_source='warp'):
            ...
            from modules.positional_adjustments import merge_positional_data_with_offensive
            if data_source == 'warp':
